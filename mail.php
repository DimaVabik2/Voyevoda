...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $content = $name . ' отправил запрос. Его почтовый ящик: ' . $email . '. Номер телефона: ' . $phone . '. ' . 'Область интересов: '. $areaOfInterest . '. Запрос: ' . $request . '.';
    ...
    $success = mail("artes30@mail.ru", 'Запрос с сайта Voyevoda', $content, $headers);
